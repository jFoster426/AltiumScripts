    ...
    Pcbserver.PreProcess;
      ...
      Begin
        ...
        Begin
          ...
          // Make sure the arcs are drawn correctly (no negative angles)
          If Arc1.StartAngle < 0 Then
          Begin
              Arc1.StartAngle := Arc1.StartAngle + 360;
          End;
          If Arc1.EndAngle < 0 Then
          Begin
              Arc1.EndAngle := Arc1.EndAngle + 360;
          End;
          If Arc2.StartAngle < 0 Then
          Begin
              Arc2.StartAngle := Arc2.StartAngle + 360;
          End;
          If Arc2.EndAngle < 0 Then
          Begin
              Arc2.EndAngle := Arc2.EndAngle + 360;
          End;
